...
class ImageTopConverter:
    ...
    def select_images(self):
        self.image_path=filedialog.askopenfilenames(title="Select Image",filetypes=[("Image Files","*.jpg;*.jpeg;*.png;*.bmp;*.gif")])
...
def main():
    ...
    converter=ImageTopConverter(root)
